          ...
          <section className="flex flex-col gap-7">
            ...
            <div className="grid gap-4">
              {DAYS.map(([day, place, detail]) => (
                <article key={day} className="rounded-[12px] border border-soft-ivory/10 bg-charcoal-blue/35 p-5">
                  <div className="text-[12px] font-misans-regular tracking-[0.18em] text-alpine-blue/80">{day}</div>
                  <h2 className="mt-2 text-[22px] font-misans-bold text-soft-ivory">{place}</h2>
                  <p className="mt-2 text-[14px] font-misans-regular leading-relaxed text-soft-ivory/68">{detail}</p>
                </article>
              ))}
            </div>
          </section>
