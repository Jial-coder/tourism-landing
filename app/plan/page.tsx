...
export default function PlanPage() {
  return (
    <>
      <TopNav />
      <main className="flex-1 bg-deep-slate text-soft-ivory">
        <section className="relative overflow-hidden px-6 pt-28 pb-12 lg:px-16 lg:pt-36 lg:pb-16">
          <div className="mx-auto flex w-full max-w-[1120px] flex-col gap-5">
            ...
            <h1 className="max-w-[760px] text-[40px] font-misans-heavy leading-[1.08] tracking-tight text-soft-ivory drop-shadow-[0_2px_8px_rgba(15,23,42,0.4)] lg:text-[72px]">
              把你的中国旅行想法发给真人顾问
            </h1>
