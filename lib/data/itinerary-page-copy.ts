...
> = {
  en: {
    meta: {
      ...
      description:
        'Start with a China route direction or send a custom request. The planning team shapes the itinerary around your month, pace, party and must-see places.',
    },
    hero: {
      eyebrow: 'Itineraries',
      ...
      publicBody:
        'These route directions are starting points, not fixed packages. Open one for the rhythm, then tell the team what to add, drop or swap.',
      emptyBody:
        'The public route library is intentionally quiet for now. Start with your travel month, party, pace and the images you keep thinking about; the planning team will turn that into a first route direction.',
    ...
    filters: {
      ...
      empty:
        'No route direction matches this combination yet. Try another filter, or tell the planning team the China you have in mind and we will write a new starting point.',
      emptyCta: 'Tell the team my version',
    ...
    emptyStudio: {
      ...
      cta: 'Ask the team for a first draft',
      points: [
        {
          icon: 'calendar',
    ...
    cta: {
      ...
      publicHeading: 'Nothing quite fits? Send the team your version.',
      emptyHeading: 'Send the team your version.',
      publicBody:
        'Most of our work is custom planning, not selling fixed templates. Send the China you want and the planning team will reply with a route direction.',
      emptyBody:
        'You do not need to choose a template first. Tell us where you want to go, when you travel, and who is coming; the planning team will send back a discussable first route.',
      button: 'Tell the team my version →',
    },
  },
  zh: {
    meta: {
      ...
      description:
        '先从路线方向或定制需求开始，顾问团队会按月份、节奏、同行人和最想看的地方整理中国行程。',
    },
    hero: {
      eyebrow: '行程',
      ...
      publicBody:
        '这里是路线方向，不是固定套餐。打开看节奏，再告诉顾问团队你想加、减、换的细节。',
      emptyBody:
        '公开路线库先保持精简。把时间、同行人、节奏和最想看的画面告诉顾问团队，先拿到一条可讨论的初版路线。',
    ...
    filters: {
      ...
      empty:
        '目前没有完全符合的路线方向。换个组合再看，或直接告诉顾问团队你想要的中国，我们替你写一条新的。',
      emptyCta: '告诉顾问团队我的版本',
      days: (days) => `${days} 天`,
    ...
    cta: {
      eyebrow: '找不到合适的？',
      publicHeading: '没有完全符合的？告诉顾问团队你的版本。',
      emptyHeading: '把你的版本发给顾问团队。',
      publicBody:
        '我们写得最多的是定制行程，不是清单里的固定模板。把你想要的中国发给顾问团队，我们会回一版路线方向。',
      emptyBody:
        '不用先选模板。告诉我们你想去哪里、什么时候出发、同行人是谁，顾问团队会先回一条可讨论的初版路线。',
      button: '告诉顾问团队我的版本 →',
    },
  },
};
