...
> = {
  en: {
    ...
    hero: {
      ...
      body:
        'This is not a catalogue of every city in China. Start with the place that pulls you most, then let the planning team shape the rest around your month, pace and travel style.',
    },
    grid: {
    ...
    filter: {
      ...
      empty:
        'No destination matches this theme yet. Try another filter, or tell the planning team the China you have in mind and we will shape a route around it.',
    ...
    cta: {
      ...
      body:
        'Send the team the city, landscape or family stop you care about. We will tell you whether it works as an anchor, a side trip, or something to save for another route.',
      button: 'Tell the team where I want to go →',
    },
  },
  zh: {
    meta: {
    ...
    hero: {
      ...
      body:
        '这不是一份中国城市大全。先选一个最能拉住你的地方，再让顾问团队按你的月份、节奏和旅行风格，把剩下的中国串起来。',
    },
    grid: {
    ...
    filter: {
      ...
      allThemes: '全部主题',
      empty:
        '目前没有这个主题的目的地。换一个主题再看，或者直接告诉顾问团队你想要的中国，我们替你串。',
      emptyCta: '告诉顾问团队我的版本',
    ...
    why: {
      ...
      paragraphs: [
        ...
        '不在这 8 个里面的目的地也可以聊。成都、杭州、敦煌、新疆、西藏都可以通过需求表单告诉顾问团队，再判断适合做主线、支线，还是留给下一趟。',
      ],
    },
    cta: {
      eyebrow: '定制路线',
      ...
      body:
        '把你在意的城市、风景或探亲节点发给顾问团队。我们会先判断它适合做路线核心、顺路支线，还是应该留给另一趟。',
      button: '告诉顾问团队我想去哪 →',
    },
  },
};
