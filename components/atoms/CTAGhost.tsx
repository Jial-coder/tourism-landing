...
const baseCls =
  "inline-flex items-center justify-center rounded-full px-8 py-3.5 whitespace-nowrap " +
...
export function CTAPrimary(props: CTAGhostProps) {
  const primaryCls =
    "inline-flex items-center justify-center rounded-full h-11 px-7 whitespace-nowrap " +
