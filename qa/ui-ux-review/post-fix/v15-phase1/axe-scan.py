"""Run axe-core scan against the 4 pages touched by v1.5 Phase 1.

Outputs JSON per page to qa/ui-ux-review/post-fix/v15-phase1/axe-{slug}.json
...
OUT = ROOT / "qa" / "ui-ux-review" / "post-fix" / "v15-phase1"
...
PAGES = [
    ...
    ("/destinations/xian", "destinations-xian"),
]
